  ...
  return (
    <div>
      ...
      <Styled._FooterAllRightReserve>
        <Text size={12}>
          Copyright ⓒ {nowYear} <Link to='https://sungbinyang.github.io'>SungbinYang</Link> All rights reserved.
        </Text>
        <Spacer y={0.1} />
        <Text size={12}>
          Created by <Link to='https://sungbinyang.github.io/'>@SungbinYang</Link>. Powered By{' '}
